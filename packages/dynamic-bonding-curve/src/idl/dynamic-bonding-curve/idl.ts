...
export type DynamicBondingCurve = {
  "address": "FP72VdSGjvExv1cnz9TYeJZ1DXDeX9pBFEo574VaST8H",
  "metadata": {
  ...
  "instructions": [
    ...
    {
      "name": "initializeVirtualPoolWithExistingSplToken",
      "discriminator": [
        168,
        153,
        160,
      ...
      "accounts": [
        ...
        },
        {
          "name": "baseMint",
          "docs": [
            "Existing token mint - must match config decimals"
          ],
          "writable": true
        },
        {
          ...
          "docs": [
            "Creator's token account to fund the pool"
          ],
          "writable": true
        },
        {
    ...
    {
      "name": "initializeVirtualPoolWithExistingToken2022",
      "discriminator": [
        123,
        135,
        15,
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "feeClaimer",
          "docs": [
            "Fee claimer (partner) can pause trading"
          ],
          "signer": true
        },
        {
    ...
    },
    {
      ...
      "accounts": [
        ...
        },
        {
          "name": "feeClaimer",
          "docs": [
            "Fee claimer (partner) can unpause trading"
          ],
          "signer": true
        },
        {
  ...
  "errors": [
    ...
    {
      "code": 6052,
      "name": "pausableModeNotEnabled",
      "msg": "Pausable mode is not enabled"
    },
    {
      "code": 6053,
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "pausableMode",
            "docs": [
              "pausable mode - allows partner/protocol to pause trading"
            ],
            "type": "u8"
          },
          {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "isPaused",
            "docs": [
              "is trading paused (only applicable if pausable_mode is enabled in config)"
            ],
            "type": "u8"
          },
          {
